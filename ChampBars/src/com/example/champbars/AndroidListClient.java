...
public class AndroidListClient extends ListActivity {
                ...
                lv.setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        	...
                        	String test = (String) ((TextView)view).getText();
                                (new GetBarInfoTask()).execute((Object)((TextView)view).getText());
         ...
         */
        @SuppressWarnings("unchecked")
        private class GetBarInfoTask extends AsyncTask {
                ...
                protected String doInBackground(Object... args) {
                        if(args != null && args[0] instanceof String) {
                                ...
                                Log.i( "GetBarInfoTask", "Name: " + bar );
                                return ServerInterface.getBarInfo(bar);
                        } else {
                                return null;
                        }
                }
